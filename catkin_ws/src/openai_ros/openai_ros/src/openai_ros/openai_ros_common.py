...
class ROSLauncher(object):
    def __init__(self, rospackage_name, launch_file_name, ros_ws_abspath="/home/dennis/simulation_ws"):
        ...
        print('The pkg_path is :', pkg_path)
    ...
    def DownloadRepo(self, package_name, ros_ws_abspath):
        ...
        """
        print('No, we need to down load the repo')
