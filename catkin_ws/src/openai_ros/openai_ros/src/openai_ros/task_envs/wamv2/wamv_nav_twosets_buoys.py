...
from openai_ros.robot_envs import wamv_env2
...
class WamvNavTwoSetsBuoysEnv(wamv_env2.WamvEnv):
    def __init__(self):
        """
        ...
        ROSLauncher(rospackage_name="vrx_gazebo",
                    launch_file_name="wuao_start_world.launch",
        ...
        rospy.loginfo("Start WamvNavTwoSetsBuoysEnv INIT...")
