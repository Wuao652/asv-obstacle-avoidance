...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    # register means loading the cartpole task env
    ...
    elif task_env == 'WamvNavTwoSetsBuoys-v1':
        
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv2.wamv_nav_twosets_buoys:WamvNavTwoSetsBuoysEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.wamv2 import wamv_nav_twosets_buoys

    elif task_env == 'WamvNavObstacles-v1':
        
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.wamv2.wamv_obstacle_avoidance:ObstacleAvoidanceEnv',
            max_episode_steps=max_episode_steps,
        )
        from openai_ros.task_envs.wamv2 import wamv_obstacle_avoidance
