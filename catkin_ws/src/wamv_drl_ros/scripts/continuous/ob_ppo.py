...
rospy.init_node('ob_ppo', anonymous=True, log_level=rospy.INFO)
...
model = PPO(policy="MlpPolicy", 
            ...
            device=device,
            tensorboard_log="./tensorboard_logs/ob_submit_ppo/")
...
model.learn(total_timesteps=1e5, log_interval=4)
model_name = "./trained_models/submit_ppo_"+str(start_time)
